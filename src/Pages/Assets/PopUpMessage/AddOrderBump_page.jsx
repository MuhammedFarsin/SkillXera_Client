...
function AddOrderBump_page() {
  ...
  const [formData, setFormData] = useState({
    ...
    bumpPrice: "",
    targetProduct: "",
    targetProductModel: "Course", // Default to course
    bumpProduct: "",
    isActive: true,
    minCartValue: "",
    image: null,
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const [coursesRes, digitalRes] = await Promise.all([
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        "/admin/assets/create-order-bump",
        formPayload,
        {
          headers: {
      ...
      toast.success("Order bump created successfully");
      if (response.status === 201) {
        setTimeout(() => navigate("/admin/assets/order-bumps"), 1500);
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
          <h1 className="text-2xl font-bold mb-6">Create New Order Bump</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g., 'Premium Workbook'"
                  className="w-full p-2 rounded border border-gray-600 bg-gray-700 text-gray-200 focus:ring-indigo-500 focus:border-indigo-500"
                  required
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Only show if cart value ≥ this amount"
                  step="0.01"
                  min="0"
                  className="w-full p-2 rounded border border-gray-600 bg-gray-700 text-gray-200 focus:ring-indigo-500 focus:border-indigo-500"
                />
...
export default AddOrderBump_page;
