        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 p-6 bg-white rounded-lg shadow-md relative">
            {filteredPayments.length > 0 ? (
              <>
                <div className="grid grid-cols-12 bg-gray-200 p-3 rounded-t-lg font-semibold text-center">
                  <input
                    type="checkbox"
                ...
                <div>
                  {filteredPayments.map((payment) => (
                    <div
                      key={payment._id}
                      className={`grid grid-cols-12 border-b h-16 rounded-lg p-3 text-center items-center transition-all ${
