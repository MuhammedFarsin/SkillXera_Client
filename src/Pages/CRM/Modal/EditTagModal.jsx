  ...
  return (
    isOpen && (
      <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 dark:bg-gray-900 dark:bg-opacity-75">
        ...
        >
          <h2 className="text-xl font-semibold mb-4 text-center text-gray-900 dark:text-gray-200">Edit Tag</h2>
          ...
          <input
            ...
            className="w-full p-2 border rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
