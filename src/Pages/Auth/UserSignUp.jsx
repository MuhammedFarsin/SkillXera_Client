    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-[#1a1a1a] to-[#004d40] flex items-center justify-center px-4">
      ...
      <div className="bg-gradient-to-r from-[#004d40] to-[#1a1a1a] p-10 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label htmlFor="name" className="block text-white text-sm">Full Name</label>
            <input
              type="text"
              id="name"
          ...
          <div className="mb-3">
            <label htmlFor="email" className="block text-white text-sm">Phone</label>
            <input
              type="number"
              id="number"
              className="w-full p-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
          ...
          <div className="mb-4">
            <label htmlFor="confirm-password" className="block text-white text-sm">Confirm Password</label>
            <input
              type="password"
              id="confirm-password"
              className="w-full p-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
